        ...
        <div className="p-6">
          ...
          <div className="flex items-center mt-2 gap-x-2">
            ...
            <Button disabled={isLoading} onClick={onCopy} size="icon">
              {copy ? <Check className="w-4 h-4 ml-2" /> : <Copy className="w-4 h-4" />}
            </Button>
          </div>
          <Button onClick={onNew} disabled={isLoading} variant="link" size="sm" className="text-sm text-zinc-500 mt-4">
            Generate a new link
